...
export default function AboutClient() {
  ...
  return (
    <div className="w-full bg-[#faf6ef] text-[#1a1208] font-sans overflow-hidden">
      ...
      {/* ── 1. Hero Section - The Vision (Split Magazine Layout) ── */}
      <section className="relative py-20 md:py-28 px-6 border-b border-[#e8d9c0]/30 bg-gradient-to-b from-[#faf6ef] to-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className={`lg:col-span-7 flex flex-col gap-6 transition-all duration-1000 ease-out ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif lobster-two-bold text-[#1a1208] leading-[1.1]">
              ...
              <span className="text-[#9c7d73] italic font-normal">Lifelong Ritual</span> <br />
              of Self-Care
            </h1>
            <div className="w-20 h-0.5 bg-[#9c7d73]/30" />
            <p className="text-lg md:text-xl lobster-two-regular-italic text-[#6b5c44] leading-relaxed max-w-2xl">
          ...
          {/* Right Arched Model Image Column */}
          <div className={`lg:col-span-5 relative w-full aspect-[4/5] rounded-[3rem] overflow-hidden shadow-lg border border-[#e8d9c0]/50 transition-all duration-1000 delay-200 ${mounted ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
            <Image
              src="/hero_model_portrait.png"
              alt="Niimi Brand Vision Model"
              fill
      ...
      {/* ── 2. Mission & Narrative Section (Staggered Collage) ── */}
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          
          {/* Visual Collage Column */}
          <div className={`lg:col-span-5 relative flex items-center justify-center min-h-[460px] w-full transition-all duration-1000 delay-100 ${mounted ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"}`}>
            {/* Background diverse models card */}
            <div className="relative w-4/5 aspect-[3/4] rounded-[2.5rem] overflow-hidden shadow-md border border-[#e8d9c0]/40 bg-[#f5e9d6]">
              <Image
          ...
          <div className={`lg:col-span-7 flex flex-col gap-6 transition-all duration-1000 delay-200 ${mounted ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
            <span className="text-xs tracking-[0.25em] text-[#9c7d73] uppercase font-bold">Why NIIMI Exists</span>
            <h2 className="text-3xl md:text-4xl font-serif text-[#1a1208] lobster-two-bold leading-tight">
              ...
              <em className="not-italic text-[#9c7d73]">East Asian Beauty</em>
            </h2>
            ...
            <div className="mt-4 p-5 rounded-3xl bg-[#faf6ef] border border-[#e8d9c0]/70 flex gap-4 items-start shadow-sm">
              <BookOpen className="w-6 h-6 text-[#9c7d73] flex-shrink-0 mt-0.5" />
              <div>
      ...
      {/* ── 3. Core Philosophy Section (4 Arched Pillars) ── */}
      <section className="bg-white py-20 md:py-28 border-t border-b border-[#e8d9c0]/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-xs tracking-[0.25em] text-[#9c7d73] uppercase font-bold block mb-2">Our Philosophy</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Pillar 1 */}
            <div className={`group bg-[#faf6ef]/40 border border-[#e8d9c0]/50 p-8 rounded-[2.5rem] shadow-sm hover:shadow-md hover:bg-white transition-all duration-300 hover:-translate-y-1 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "100ms" }}>
              <div className="w-12 h-12 rounded-2xl bg-white border border-[#e8d9c0]/50 flex items-center justify-center text-[#9c7d73] mb-6 group-hover:bg-[#9c7d73] group-hover:text-white transition-all duration-300">
                <Smile className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-[#1a1208] mb-3 font-serif lobster-two-bold">Skin, Not Perfection</h3>
              <p className="text-xs text-[#6b5c44] leading-relaxed">
            ...
            {/* Pillar 2 */}
            <div className={`group bg-[#faf6ef]/40 border border-[#e8d9c0]/50 p-8 rounded-[2.5rem] shadow-sm hover:shadow-md hover:bg-white transition-all duration-300 hover:-translate-y-1 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "200ms" }}>
              <div className="w-12 h-12 rounded-2xl bg-white border border-[#e8d9c0]/50 flex items-center justify-center text-[#9c7d73] mb-6 group-hover:bg-[#9c7d73] group-hover:text-white transition-all duration-300">
                <Sparkles className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-[#1a1208] mb-3 font-serif lobster-two-bold">Never a Burden</h3>
              <p className="text-xs text-[#6b5c44] leading-relaxed">
            ...
            {/* Pillar 3 */}
            <div className={`group bg-[#faf6ef]/40 border border-[#e8d9c0]/50 p-8 rounded-[2.5rem] shadow-sm hover:shadow-md hover:bg-white transition-all duration-300 hover:-translate-y-1 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "300ms" }}>
              <div className="w-12 h-12 rounded-2xl bg-white border border-[#e8d9c0]/50 flex items-center justify-center text-[#9c7d73] mb-6 group-hover:bg-[#9c7d73] group-hover:text-white transition-all duration-300">
                <Clock className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-[#1a1208] mb-3 font-serif lobster-two-bold">Luxury is Time</h3>
              <p className="text-xs text-[#6b5c44] leading-relaxed">
            ...
            {/* Pillar 4 */}
            <div className={`group bg-[#faf6ef]/40 border border-[#e8d9c0]/50 p-8 rounded-[2.5rem] shadow-sm hover:shadow-md hover:bg-white transition-all duration-300 hover:-translate-y-1 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "400ms" }}>
              <div className="w-12 h-12 rounded-2xl bg-white border border-[#e8d9c0]/50 flex items-center justify-center text-[#9c7d73] mb-6 group-hover:bg-[#9c7d73] group-hover:text-white transition-all duration-300">
                <CheckCircle className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-[#1a1208] mb-3 font-serif lobster-two-bold">Honest Sourcing</h3>
              <p className="text-xs text-[#6b5c44] leading-relaxed">
      ...
      {/* ── 4. Brand Values Section (Floating glassmorphism) ── */}
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        <div className="text-center mb-16">
          <span className="text-xs tracking-[0.25em] text-[#9c7d73] uppercase font-bold block mb-2">Our Foundation</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          {[
            ...
            <div 
              key={val.name}
              className={`p-6 rounded-3xl bg-white border border-[#e8d9c0]/50 shadow-sm flex flex-col justify-between hover:shadow-md transition-all duration-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
              style={{ transitionDelay: `${i * 100}ms` }}
            >
              <div>
                <div className="w-10 h-10 rounded-xl bg-[#faf6ef] border border-[#e8d9c0]/50 flex items-center justify-center text-[#9c7d73] mb-4">
                  {val.icon}
                </div>
                <h4 className="text-lg font-serif font-bold text-[#1a1208] lobster-two-bold mb-2">{val.name}</h4>
      ...
      {/* ── 5. Grayscale overlay banner ("The Change We Seek") ── */}
      <section className="relative w-full min-h-[550px] flex items-center justify-center bg-[#1a1208] text-white py-20 md:py-28 px-6 overflow-hidden">
        ...
        <div className={`relative z-10 max-w-4xl mx-auto text-center flex flex-col gap-6 items-center transition-all duration-1000 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="text-xs tracking-[0.25em] text-[#9c7d73] uppercase font-bold">The Change We Seek</span>
          ...
          <div className="w-16 h-px bg-[#9c7d73] my-4" />

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl text-left mt-2">
            <div>
              <h4 className="text-[#9c7d73] font-bold text-sm uppercase tracking-wider mb-2">Our True Goal</h4>
            ...
            <div>
              <h4 className="text-[#9c7d73] font-bold text-sm uppercase tracking-wider mb-2">Empowered by Knowledge</h4>
              <p className="text-xs text-gray-400 leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 md:py-28 text-center">
        <div className={`flex flex-col items-center gap-6 transition-all duration-1000 delay-400 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <span className="text-xs tracking-[0.25em] text-[#9c7d73] uppercase font-bold block">Our Commitment</span>
          <h2 className="text-2xl md:text-3xl font-serif text-[#1a1208] lobster-two-bold">
            The Customer Pledge
          </h2>
          
          <div className="w-12 h-0.5 bg-[#9c7d73]" />

          <div className="relative p-8 md:p-12 rounded-[2.5rem] bg-[#faf6ef] border border-[#e8d9c0] mt-4 max-w-3xl shadow-sm">
            <div className="absolute top-4 left-6 text-6xl text-[#9c7d73]/20 font-serif pointer-events-none">&ldquo;</div>
            ...
            <div className="absolute bottom-2 right-6 text-6xl text-[#9c7d73]/20 font-serif pointer-events-none">&rdquo;</div>
          </div>
          ...
          <div className="pt-8 flex flex-wrap gap-4 justify-center">
            <Link
              href="/team"
              className="inline-flex items-center gap-2 rounded-full bg-[#1a1208] px-8 py-3.5 font-bold text-white shadow-md hover:bg-[#9c7d73] transition-colors duration-200 text-sm uppercase tracking-wider"
            >
              Meet the Founders
